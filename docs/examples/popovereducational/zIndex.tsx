...
const HALLOWEEN_CUSTOMES_LABEL = 'HALLOWEEN_CUSTOMES_LABEL';
const POPOVER_EDUCATIONAL_LABEL = 'POPOVER_EDUCATIONAL_LABEL';
...
export default function Example() {
  ...
  return (
    <StackingContextProvider labels={[HALLOWEEN_CUSTOMES_LABEL, POPOVER_EDUCATIONAL_LABEL]}>
      <Flex
        alignItems="center"
        direction="column"
        gap={12}
        ...
        <Flex gap={2}>
          ...
          {open && (
            <PopoverEducational
              ...
              zIndexLabel={hasZindex ? POPOVER_EDUCATIONAL_LABEL : undefined}
            />
          )}
          <Box
            color="secondary"
            ...
            rounding={3}
            width={200}
            zIndexLabel={HALLOWEEN_CUSTOMES_LABEL}
          >
            <Flex gap={2}>
              <Box aria-hidden width={50}>
                <Mask rounding={3} wash>
